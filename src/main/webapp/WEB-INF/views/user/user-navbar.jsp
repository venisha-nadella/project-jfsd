    ...
    <nav class="navbar">
        ...
        <!-- Navbar Links Section -->
            ...
            <div class="navbar-item has-dropdown">
                <a href="<%= request.getContextPath() %>/courses/enrolled-courses" class="dropdown-item">Dashboard</a>
            </div>
            ...
            <div class="navbar-item has-dropdown">
                    <a href="<%= request.getContextPath() %>/courses" class="dropdown-item">Available Courses</a>
            </div>
